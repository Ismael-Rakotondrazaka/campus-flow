...
export const RefreshTokenScalarFieldEnumSchema = z.enum(['id','token','userId','expiresAt','createdAt','updatedAt']);
...
export const ReservationScalarFieldEnumSchema = z.enum(['id','name','firstName','phoneNumber','profileUrl','email','gender','origin','emergencyNumber','NIC','NICUrl','schoolCertificateUrl','facultyId','status','academicSessionId','createdAt','updatedAt','adminId','refusalReason']);

export const RenewalScalarFieldEnumSchema = z.enum(['id','studentId','phoneNumber','emergencyNumber','profileUrl','schoolCertificateUrl','NICUrl','academicSessionId','status','createdAt','updatedAt','facultyId','adminId','refusalReason']);
...
export const AcademicSessionScalarFieldEnumSchema = z.enum(['id','startAt','endAt','createdAt','updatedAt','deletedAt']);

export const BuildingScalarFieldEnumSchema = z.enum(['id','name','floors','illustrationUrl','createdAt','updatedAt','deletedAt']);
...
export const PasswordResetTokenScalarFieldEnumSchema = z.enum(['token','createdAt','updatedAt','expiresAt','userId']);
...
export const RefusalReasonSchema = z.enum(['CAPACITY_LIMIT_REACHED','INCOMPLETE_DOCUMENTS','FALSIFIED_DOCUMENTS','PAST_BEHAVIOR','INELIGIBILITY','OTHER']);

export type RefusalReasonType = `${z.infer<typeof RefusalReasonSchema>}`
...
export const ReservationSelectSchema: z.ZodType<Prisma.ReservationSelect> = z.object({
  ...
  refusalReason: z.boolean().optional(),
  faculty: z.union([z.boolean(),z.lazy(() => FacultyArgsSchema)]).optional(),
  academicSession: z.union([z.boolean(),z.lazy(() => AcademicSessionArgsSchema)]).optional(),
  admin: z.union([z.boolean(),z.lazy(() => AdminArgsSchema)]).optional(),
}).strict()
...
export const ReservationWhereInputSchema: z.ZodType<Prisma.ReservationWhereInput> = z.object({
  ...
  refusalReason: z.union([ z.lazy(() => EnumRefusalReasonNullableFilterSchema),z.lazy(() => RefusalReasonSchema) ]).optional().nullable(),
  faculty: z.union([ z.lazy(() => FacultyRelationFilterSchema),z.lazy(() => FacultyWhereInputSchema) ]).optional(),
  academicSession: z.union([ z.lazy(() => AcademicSessionRelationFilterSchema),z.lazy(() => AcademicSessionWhereInputSchema) ]).optional(),
...
export const ReservationOrderByWithRelationInputSchema: z.ZodType<Prisma.ReservationOrderByWithRelationInput> = z.object({
  ...
  refusalReason: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  faculty: z.lazy(() => FacultyOrderByWithRelationInputSchema).optional(),
  academicSession: z.lazy(() => AcademicSessionOrderByWithRelationInputSchema).optional(),
  admin: z.lazy(() => AdminOrderByWithRelationInputSchema).optional()
}).strict();
...
export const ReservationScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ReservationScalarWhereWithAggregatesInput> = z.object({
  ...
  refusalReason: z.union([ z.lazy(() => EnumRefusalReasonNullableWithAggregatesFilterSchema),z.lazy(() => RefusalReasonSchema) ]).optional().nullable(),
}).strict();
...
export const LodgmentUpdateInputSchema: z.ZodType<Prisma.LodgmentUpdateInput> = z.object({
  ...
  maintenances: z.lazy(() => MaintenanceUpdateManyWithoutLodgmentNestedInputSchema).optional()
}).strict();
...
export const ReservationCreateInputSchema: z.ZodType<Prisma.ReservationCreateInput> = z.object({
  ...
  academicSession: z.lazy(() => AcademicSessionCreateNestedOneWithoutReservationsInputSchema),
...
export const ReservationUpdateInputSchema: z.ZodType<Prisma.ReservationUpdateInput> = z.object({
  ...
  academicSession: z.lazy(() => AcademicSessionUpdateOneRequiredWithoutReservationsNestedInputSchema).optional(),
...
export const EnumRefusalReasonNullableFilterSchema: z.ZodType<Prisma.EnumRefusalReasonNullableFilter> = z.object({
  equals: z.lazy(() => RefusalReasonSchema).optional().nullable(),
...
export const ReservationCountOrderByAggregateInputSchema: z.ZodType<Prisma.ReservationCountOrderByAggregateInput> = z.object({
  ...
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  adminId: z.lazy(() => SortOrderSchema).optional(),
  refusalReason: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const EnumRefusalReasonNullableWithAggregatesFilterSchema: z.ZodType<Prisma.EnumRefusalReasonNullableWithAggregatesFilter> = z.object({
  equals: z.lazy(() => RefusalReasonSchema).optional().nullable(),
  in: z.lazy(() => RefusalReasonSchema).array().optional().nullable(),
  notIn: z.lazy(() => RefusalReasonSchema).array().optional().nullable(),
  not: z.union([ z.lazy(() => RefusalReasonSchema),z.lazy(() => NestedEnumRefusalReasonNullableWithAggregatesFilterSchema) ]).optional().nullable(),
  _count: z.lazy(() => NestedIntNullableFilterSchema).optional(),
  _min: z.lazy(() => NestedEnumRefusalReasonNullableFilterSchema).optional(),
  _max: z.lazy(() => NestedEnumRefusalReasonNullableFilterSchema).optional()
}).strict();
...
export const MaintenanceCreateNestedManyWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceCreateNestedManyWithoutLodgmentInput> = z.object({
  create: z.union([ z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema).array(),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => MaintenanceCreateOrConnectWithoutLodgmentInputSchema),z.lazy(() => MaintenanceCreateOrConnectWithoutLodgmentInputSchema).array() ]).optional(),
  createMany: z.lazy(() => MaintenanceCreateManyLodgmentInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => MaintenanceWhereUniqueInputSchema),z.lazy(() => MaintenanceWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const MaintenanceUncheckedCreateNestedManyWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceUncheckedCreateNestedManyWithoutLodgmentInput> = z.object({
  create: z.union([ z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema).array(),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => MaintenanceCreateOrConnectWithoutLodgmentInputSchema),z.lazy(() => MaintenanceCreateOrConnectWithoutLodgmentInputSchema).array() ]).optional(),
  createMany: z.lazy(() => MaintenanceCreateManyLodgmentInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => MaintenanceWhereUniqueInputSchema),z.lazy(() => MaintenanceWhereUniqueInputSchema).array() ]).optional(),
...
export const MaintenanceUpdateManyWithoutLodgmentNestedInputSchema: z.ZodType<Prisma.MaintenanceUpdateManyWithoutLodgmentNestedInput> = z.object({
  create: z.union([ z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema).array(),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => MaintenanceCreateOrConnectWithoutLodgmentInputSchema),z.lazy(() => MaintenanceCreateOrConnectWithoutLodgmentInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => MaintenanceUpsertWithWhereUniqueWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUpsertWithWhereUniqueWithoutLodgmentInputSchema).array() ]).optional(),
  createMany: z.lazy(() => MaintenanceCreateManyLodgmentInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => MaintenanceWhereUniqueInputSchema),z.lazy(() => MaintenanceWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => MaintenanceWhereUniqueInputSchema),z.lazy(() => MaintenanceWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => MaintenanceWhereUniqueInputSchema),z.lazy(() => MaintenanceWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => MaintenanceWhereUniqueInputSchema),z.lazy(() => MaintenanceWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => MaintenanceUpdateWithWhereUniqueWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUpdateWithWhereUniqueWithoutLodgmentInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => MaintenanceUpdateManyWithWhereWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUpdateManyWithWhereWithoutLodgmentInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => MaintenanceScalarWhereInputSchema),z.lazy(() => MaintenanceScalarWhereInputSchema).array() ]).optional(),
}).strict();
...
export const MaintenanceUncheckedUpdateManyWithoutLodgmentNestedInputSchema: z.ZodType<Prisma.MaintenanceUncheckedUpdateManyWithoutLodgmentNestedInput> = z.object({
  create: z.union([ z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema).array(),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => MaintenanceCreateOrConnectWithoutLodgmentInputSchema),z.lazy(() => MaintenanceCreateOrConnectWithoutLodgmentInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => MaintenanceUpsertWithWhereUniqueWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUpsertWithWhereUniqueWithoutLodgmentInputSchema).array() ]).optional(),
  createMany: z.lazy(() => MaintenanceCreateManyLodgmentInputEnvelopeSchema).optional(),
...
export const AcademicSessionCreateNestedOneWithoutReservationsInputSchema: z.ZodType<Prisma.AcademicSessionCreateNestedOneWithoutReservationsInput> = z.object({
  create: z.union([ z.lazy(() => AcademicSessionCreateWithoutReservationsInputSchema),z.lazy(() => AcademicSessionUncheckedCreateWithoutReservationsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => AcademicSessionCreateOrConnectWithoutReservationsInputSchema).optional(),
  connect: z.lazy(() => AcademicSessionWhereUniqueInputSchema).optional()
}).strict();
...
export const NullableEnumRefusalReasonFieldUpdateOperationsInputSchema: z.ZodType<Prisma.NullableEnumRefusalReasonFieldUpdateOperationsInput> = z.object({
  set: z.lazy(() => RefusalReasonSchema).optional().nullable()
}).strict();
...
export const AcademicSessionUpdateOneRequiredWithoutReservationsNestedInputSchema: z.ZodType<Prisma.AcademicSessionUpdateOneRequiredWithoutReservationsNestedInput> = z.object({
  create: z.union([ z.lazy(() => AcademicSessionCreateWithoutReservationsInputSchema),z.lazy(() => AcademicSessionUncheckedCreateWithoutReservationsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => AcademicSessionCreateOrConnectWithoutReservationsInputSchema).optional(),
  upsert: z.lazy(() => AcademicSessionUpsertWithoutReservationsInputSchema).optional(),
  connect: z.lazy(() => AcademicSessionWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => AcademicSessionUpdateToOneWithWhereWithoutReservationsInputSchema),z.lazy(() => AcademicSessionUpdateWithoutReservationsInputSchema),z.lazy(() => AcademicSessionUncheckedUpdateWithoutReservationsInputSchema) ]).optional(),
}).strict();
...
export const AcademicSessionCreateNestedOneWithoutRenewalsInputSchema: z.ZodType<Prisma.AcademicSessionCreateNestedOneWithoutRenewalsInput> = z.object({
  create: z.union([ z.lazy(() => AcademicSessionCreateWithoutRenewalsInputSchema),z.lazy(() => AcademicSessionUncheckedCreateWithoutRenewalsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => AcademicSessionCreateOrConnectWithoutRenewalsInputSchema).optional(),
  connect: z.lazy(() => AcademicSessionWhereUniqueInputSchema).optional()
}).strict();
...
export const AcademicSessionUpdateOneRequiredWithoutRenewalsNestedInputSchema: z.ZodType<Prisma.AcademicSessionUpdateOneRequiredWithoutRenewalsNestedInput> = z.object({
  create: z.union([ z.lazy(() => AcademicSessionCreateWithoutRenewalsInputSchema),z.lazy(() => AcademicSessionUncheckedCreateWithoutRenewalsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => AcademicSessionCreateOrConnectWithoutRenewalsInputSchema).optional(),
  upsert: z.lazy(() => AcademicSessionUpsertWithoutRenewalsInputSchema).optional(),
  connect: z.lazy(() => AcademicSessionWhereUniqueInputSchema).optional(),
...
export const LodgmentCreateNestedOneWithoutMaintenancesInputSchema: z.ZodType<Prisma.LodgmentCreateNestedOneWithoutMaintenancesInput> = z.object({
  create: z.union([ z.lazy(() => LodgmentCreateWithoutMaintenancesInputSchema),z.lazy(() => LodgmentUncheckedCreateWithoutMaintenancesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => LodgmentCreateOrConnectWithoutMaintenancesInputSchema).optional(),
  connect: z.lazy(() => LodgmentWhereUniqueInputSchema).optional()
}).strict();
...
export const LodgmentUpdateOneRequiredWithoutMaintenancesNestedInputSchema: z.ZodType<Prisma.LodgmentUpdateOneRequiredWithoutMaintenancesNestedInput> = z.object({
  create: z.union([ z.lazy(() => LodgmentCreateWithoutMaintenancesInputSchema),z.lazy(() => LodgmentUncheckedCreateWithoutMaintenancesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => LodgmentCreateOrConnectWithoutMaintenancesInputSchema).optional(),
  upsert: z.lazy(() => LodgmentUpsertWithoutMaintenancesInputSchema).optional(),
  connect: z.lazy(() => LodgmentWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => LodgmentUpdateToOneWithWhereWithoutMaintenancesInputSchema),z.lazy(() => LodgmentUpdateWithoutMaintenancesInputSchema),z.lazy(() => LodgmentUncheckedUpdateWithoutMaintenancesInputSchema) ]).optional(),
}).strict();
...
export const NestedEnumRefusalReasonNullableFilterSchema: z.ZodType<Prisma.NestedEnumRefusalReasonNullableFilter> = z.object({
  equals: z.lazy(() => RefusalReasonSchema).optional().nullable(),
  in: z.lazy(() => RefusalReasonSchema).array().optional().nullable(),
  notIn: z.lazy(() => RefusalReasonSchema).array().optional().nullable(),
  not: z.union([ z.lazy(() => RefusalReasonSchema),z.lazy(() => NestedEnumRefusalReasonNullableFilterSchema) ]).optional().nullable(),
...
export const NestedEnumRefusalReasonNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumRefusalReasonNullableWithAggregatesFilter> = z.object({
  equals: z.lazy(() => RefusalReasonSchema).optional().nullable(),
  in: z.lazy(() => RefusalReasonSchema).array().optional().nullable(),
  notIn: z.lazy(() => RefusalReasonSchema).array().optional().nullable(),
  not: z.union([ z.lazy(() => RefusalReasonSchema),z.lazy(() => NestedEnumRefusalReasonNullableWithAggregatesFilterSchema) ]).optional().nullable(),
...
export const MaintenanceCreateWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceCreateWithoutLodgmentInput> = z.object({
  type: z.lazy(() => MaintenanceTypeSchema),
  description: z.string().optional().nullable(),
  status: z.lazy(() => MaintenanceStatusSchema),
  startAt: z.coerce.date().optional().nullable(),
...
export const MaintenanceUncheckedCreateWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceUncheckedCreateWithoutLodgmentInput> = z.object({
  id: z.number().int().optional(),
  type: z.lazy(() => MaintenanceTypeSchema),
  description: z.string().optional().nullable(),
  status: z.lazy(() => MaintenanceStatusSchema),
...
export const MaintenanceCreateOrConnectWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceCreateOrConnectWithoutLodgmentInput> = z.object({
  where: z.lazy(() => MaintenanceWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema) ]),
}).strict();

export const MaintenanceCreateManyLodgmentInputEnvelopeSchema: z.ZodType<Prisma.MaintenanceCreateManyLodgmentInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => MaintenanceCreateManyLodgmentInputSchema),z.lazy(() => MaintenanceCreateManyLodgmentInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();
...
export const MaintenanceUpsertWithWhereUniqueWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceUpsertWithWhereUniqueWithoutLodgmentInput> = z.object({
  where: z.lazy(() => MaintenanceWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => MaintenanceUpdateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUncheckedUpdateWithoutLodgmentInputSchema) ]),
  create: z.union([ z.lazy(() => MaintenanceCreateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUncheckedCreateWithoutLodgmentInputSchema) ]),
}).strict();

export const MaintenanceUpdateWithWhereUniqueWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceUpdateWithWhereUniqueWithoutLodgmentInput> = z.object({
  where: z.lazy(() => MaintenanceWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => MaintenanceUpdateWithoutLodgmentInputSchema),z.lazy(() => MaintenanceUncheckedUpdateWithoutLodgmentInputSchema) ]),
}).strict();

export const MaintenanceUpdateManyWithWhereWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceUpdateManyWithWhereWithoutLodgmentInput> = z.object({
  where: z.lazy(() => MaintenanceScalarWhereInputSchema),
  data: z.union([ z.lazy(() => MaintenanceUpdateManyMutationInputSchema),z.lazy(() => MaintenanceUncheckedUpdateManyWithoutLodgmentInputSchema) ]),
}).strict();
...
export const AcademicSessionCreateWithoutReservationsInputSchema: z.ZodType<Prisma.AcademicSessionCreateWithoutReservationsInput> = z.object({
  startAt: z.coerce.date(),
  endAt: z.coerce.date(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const AcademicSessionCreateOrConnectWithoutReservationsInputSchema: z.ZodType<Prisma.AcademicSessionCreateOrConnectWithoutReservationsInput> = z.object({
  where: z.lazy(() => AcademicSessionWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => AcademicSessionCreateWithoutReservationsInputSchema),z.lazy(() => AcademicSessionUncheckedCreateWithoutReservationsInputSchema) ]),
}).strict();
...
export const AcademicSessionUpsertWithoutReservationsInputSchema: z.ZodType<Prisma.AcademicSessionUpsertWithoutReservationsInput> = z.object({
  update: z.union([ z.lazy(() => AcademicSessionUpdateWithoutReservationsInputSchema),z.lazy(() => AcademicSessionUncheckedUpdateWithoutReservationsInputSchema) ]),
  create: z.union([ z.lazy(() => AcademicSessionCreateWithoutReservationsInputSchema),z.lazy(() => AcademicSessionUncheckedCreateWithoutReservationsInputSchema) ]),
  where: z.lazy(() => AcademicSessionWhereInputSchema).optional()
}).strict();

export const AcademicSessionUpdateToOneWithWhereWithoutReservationsInputSchema: z.ZodType<Prisma.AcademicSessionUpdateToOneWithWhereWithoutReservationsInput> = z.object({
  where: z.lazy(() => AcademicSessionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => AcademicSessionUpdateWithoutReservationsInputSchema),z.lazy(() => AcademicSessionUncheckedUpdateWithoutReservationsInputSchema) ]),
}).strict();

export const AcademicSessionUpdateWithoutReservationsInputSchema: z.ZodType<Prisma.AcademicSessionUpdateWithoutReservationsInput> = z.object({
  startAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AcademicSessionCreateWithoutRenewalsInputSchema: z.ZodType<Prisma.AcademicSessionCreateWithoutRenewalsInput> = z.object({
  startAt: z.coerce.date(),
  endAt: z.coerce.date(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
...
export const AcademicSessionCreateOrConnectWithoutRenewalsInputSchema: z.ZodType<Prisma.AcademicSessionCreateOrConnectWithoutRenewalsInput> = z.object({
  where: z.lazy(() => AcademicSessionWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => AcademicSessionCreateWithoutRenewalsInputSchema),z.lazy(() => AcademicSessionUncheckedCreateWithoutRenewalsInputSchema) ]),
}).strict();
...
export const AcademicSessionUpsertWithoutRenewalsInputSchema: z.ZodType<Prisma.AcademicSessionUpsertWithoutRenewalsInput> = z.object({
  update: z.union([ z.lazy(() => AcademicSessionUpdateWithoutRenewalsInputSchema),z.lazy(() => AcademicSessionUncheckedUpdateWithoutRenewalsInputSchema) ]),
  create: z.union([ z.lazy(() => AcademicSessionCreateWithoutRenewalsInputSchema),z.lazy(() => AcademicSessionUncheckedCreateWithoutRenewalsInputSchema) ]),
  where: z.lazy(() => AcademicSessionWhereInputSchema).optional()
}).strict();

export const AcademicSessionUpdateToOneWithWhereWithoutRenewalsInputSchema: z.ZodType<Prisma.AcademicSessionUpdateToOneWithWhereWithoutRenewalsInput> = z.object({
  where: z.lazy(() => AcademicSessionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => AcademicSessionUpdateWithoutRenewalsInputSchema),z.lazy(() => AcademicSessionUncheckedUpdateWithoutRenewalsInputSchema) ]),
}).strict();

export const AcademicSessionUpdateWithoutRenewalsInputSchema: z.ZodType<Prisma.AcademicSessionUpdateWithoutRenewalsInput> = z.object({
  startAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  endAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LodgmentCreateWithoutMaintenancesInputSchema: z.ZodType<Prisma.LodgmentCreateWithoutMaintenancesInput> = z.object({
  capacity: z.number().int(),
  floor: z.number().int(),
  roomNumber: z.number().int(),
  status: z.lazy(() => LodgmentStatusSchema),
...
export const LodgmentUncheckedCreateWithoutMaintenancesInputSchema: z.ZodType<Prisma.LodgmentUncheckedCreateWithoutMaintenancesInput> = z.object({
  id: z.number().int().optional(),
  capacity: z.number().int(),
  floor: z.number().int(),
  roomNumber: z.number().int(),
...
export const LodgmentCreateOrConnectWithoutMaintenancesInputSchema: z.ZodType<Prisma.LodgmentCreateOrConnectWithoutMaintenancesInput> = z.object({
  where: z.lazy(() => LodgmentWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => LodgmentCreateWithoutMaintenancesInputSchema),z.lazy(() => LodgmentUncheckedCreateWithoutMaintenancesInputSchema) ]),
}).strict();
...
export const LodgmentUpsertWithoutMaintenancesInputSchema: z.ZodType<Prisma.LodgmentUpsertWithoutMaintenancesInput> = z.object({
  update: z.union([ z.lazy(() => LodgmentUpdateWithoutMaintenancesInputSchema),z.lazy(() => LodgmentUncheckedUpdateWithoutMaintenancesInputSchema) ]),
  create: z.union([ z.lazy(() => LodgmentCreateWithoutMaintenancesInputSchema),z.lazy(() => LodgmentUncheckedCreateWithoutMaintenancesInputSchema) ]),
  where: z.lazy(() => LodgmentWhereInputSchema).optional()
}).strict();

export const LodgmentUpdateToOneWithWhereWithoutMaintenancesInputSchema: z.ZodType<Prisma.LodgmentUpdateToOneWithWhereWithoutMaintenancesInput> = z.object({
  where: z.lazy(() => LodgmentWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LodgmentUpdateWithoutMaintenancesInputSchema),z.lazy(() => LodgmentUncheckedUpdateWithoutMaintenancesInputSchema) ]),
}).strict();

export const LodgmentUpdateWithoutMaintenancesInputSchema: z.ZodType<Prisma.LodgmentUpdateWithoutMaintenancesInput> = z.object({
  capacity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  floor: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  roomNumber: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.lazy(() => LodgmentStatusSchema),z.lazy(() => EnumLodgmentStatusFieldUpdateOperationsInputSchema) ]).optional(),
...
export const LodgmentUncheckedUpdateWithoutMaintenancesInputSchema: z.ZodType<Prisma.LodgmentUncheckedUpdateWithoutMaintenancesInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  capacity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  floor: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  roomNumber: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const MaintenanceCreateManyLodgmentInputSchema: z.ZodType<Prisma.MaintenanceCreateManyLodgmentInput> = z.object({
  id: z.number().int().optional(),
  type: z.lazy(() => MaintenanceTypeSchema),
  description: z.string().optional().nullable(),
  status: z.lazy(() => MaintenanceStatusSchema),
...
export const MaintenanceUpdateWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceUpdateWithoutLodgmentInput> = z.object({
  type: z.union([ z.lazy(() => MaintenanceTypeSchema),z.lazy(() => EnumMaintenanceTypeFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  status: z.union([ z.lazy(() => MaintenanceStatusSchema),z.lazy(() => EnumMaintenanceStatusFieldUpdateOperationsInputSchema) ]).optional(),
  startAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const MaintenanceUncheckedUpdateWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceUncheckedUpdateWithoutLodgmentInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  type: z.union([ z.lazy(() => MaintenanceTypeSchema),z.lazy(() => EnumMaintenanceTypeFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  status: z.union([ z.lazy(() => MaintenanceStatusSchema),z.lazy(() => EnumMaintenanceStatusFieldUpdateOperationsInputSchema) ]).optional(),
...
export const MaintenanceUncheckedUpdateManyWithoutLodgmentInputSchema: z.ZodType<Prisma.MaintenanceUncheckedUpdateManyWithoutLodgmentInput> = z.object({
  id: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  type: z.union([ z.lazy(() => MaintenanceTypeSchema),z.lazy(() => EnumMaintenanceTypeFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  status: z.union([ z.lazy(() => MaintenanceStatusSchema),z.lazy(() => EnumMaintenanceStatusFieldUpdateOperationsInputSchema) ]).optional(),
